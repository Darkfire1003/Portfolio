const projectsData = [
  ...
  },
  {
    ...
    longDescription:
      "Eine vollständige Wetteranwendung mit Live-Wetterdaten über die WeatherAPI. Nutzer können Städte suchen und erhalten aktuelle Wetterdaten, 3-Tage Forecasts, astronomische Daten wie Sonnenaufgang, Sonnenuntergang und Mondphase. Zusätzlich habe ich ein eigenes Suchverlaufs-System mit Deduplizierung, Suchzähler, Top-5 Städten und localStorage umgesetzt. Die Wetterdaten werden zusätzlich über ein eigenes Strapi Backend gespeichert. Fokus des Projekts war State-Management in Vanilla JavaScript, API-Handling, Responsive Design und die Verbindung von Frontend und Backend.",
    tags: [
      "JavaScript",
      "Tailwind CSS",
      "Weather API",
    ...
    link: "https://darkfire1003.github.io/Weather-App/",
